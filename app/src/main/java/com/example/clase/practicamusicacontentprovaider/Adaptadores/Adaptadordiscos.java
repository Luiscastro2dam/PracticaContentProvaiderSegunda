 ...
 */
public class Adaptadordiscos extends ArrayAdapter<Cancion>{
    ...
    public Adaptadordiscos(Context context, int resource, ArrayList<Cancion> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        gv.tvTitulo.setText(valores.get(position).getAlbum());
